    ...
    >
        <div class="space-y-3">
            ...
            >
                ...
                >
                    <div class="mb-2 text-xs font-semibold text-purple-800">
                    ...
                    <div class="space-y-1.5">
                        ...
                        >
                            ...
                            <span
                                ...
                                >{{ item.qty }}</span
                            >
                            <span class="w-28 text-left text-xs text-gray-500"
                                >{{
                ...
                <div v-if="selectedBundles.length" class="mt-2 space-y-1.5">
                    ...
                    >
                        <span class="flex-1 font-medium text-purple-800"
                            >📦 {{ b.name }}</span
                        >
                        <span
                        ...
                        <button
                            ...
                            @click="removeBundleFromSelected(idx)"
                        >
                            ×
                        </button>
                    </div>
